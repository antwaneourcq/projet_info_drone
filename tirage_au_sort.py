...
# environnement = liste de deux intervalles représentés par des tuples, correspondant à l'intervalle des abcsisses et des ordonnées
    p = 5/100
    a,b,c,d = carte[0][0], carte[0][1] , carte[1][0] , carte[1][1]
    #je définis les limites de l'espace intérieur pour les clients
